...
import { Heart, Users, Github, Twitter, Mail } from 'lucide-react'

const footerLinks = {
  platform: [
    { href: '/', label: 'Home' },
    { href: '/issues', label: 'Browse Issues' },
    { href: '/new-post', label: 'Report Issue' },
  ],
  community: [
...
const socialLinks = [
  ...
  { href: 'mailto:contact@voicesonpoverty.org', icon: Mail, label: 'Email' },
] as const
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {currentYear} Voices on Poverty. All rights reserved.
          </p>
