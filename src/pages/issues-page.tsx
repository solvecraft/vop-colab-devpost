...
const mockIssues = [
  {
    ...
    description: 'Many families in our village have been without clean water for weeks. The main well has dried up and the nearest water source is 5km away.',
  ...
  },
  {
    ...
    description: 'The housing situation in our area is deteriorating rapidly. Many families are living in overcrowded conditions without proper sanitation.',
    author: 'Michael Chen',
    voiceLevel: 32,
  ...
  },
  {
    ...
    description: 'Schools in our district lack basic resources and qualified teachers. Children are walking 10km daily to reach the nearest school.',
    author: 'Amara Okafor',
    voiceLevel: 67,
  ...
  },
  {
    ...
    description: 'The main road to our community has been damaged for months. Emergency services cannot reach us during the rainy season.',
...
export function IssuesPage() {
  ...
  const filteredIssues = mockIssues.filter(issue => {
    ...
    const matchesFilter = selectedFilter === 'all' || issue.types.includes(selectedFilter)
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant={selectedFilter === 'Housing' ? 'default' : 'outline'}
                size="sm"
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center text-primary">
                        ...
                        <span className="text-xs font-medium">Level {issue.voiceLevel}</span>
                      </div>
                    </div>
